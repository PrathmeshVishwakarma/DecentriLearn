...
from trainer import train, test, train_fedprox
...
for digit in range(10):
    ...
    local_model = train_fedprox(model=local_model, global_model=main_model, dataloader=augmented_train_loader[digit], device=device)
